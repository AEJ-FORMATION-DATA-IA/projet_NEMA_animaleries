<?php
    ...
    if(!empty($_POST))
    {
        ...
        {
            $db = Database::connect();
            $statement = $db->prepare("INSERT INTO categorie (categorie) values(?)");
...
<head>
    ...
    <div class="container admin">
            ...
            <?php require 'menu.php'; ?>
                <h1><strong>Ajouter une categorie d'animal</strong></h1>
                <br>
                    <form action="insert_categorie.php" role="form" method="post" class="form">
