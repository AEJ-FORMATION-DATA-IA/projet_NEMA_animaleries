<?php
    ...
    if(!empty($_POST))
    {
        ...
        $db = Database::connect();
        $statement = $db->prepare("DELETE FROM categorie WHERE id_categorie = ?");
...
<head>
    ...
    <div class="container admin">
            <div class="row">
                    ...
                    <br>
                <form action="delete_categorie.php" role="form" method="post" class="form">
                        <input type="hidden" name="id" value="<?php echo $id;?>" />
                        <p class="alert alert-warning">Etes vous sur de vouloir supprimer ?</p>    
                        <div class="form-actions">
                            <button type="submit" class="btn btn-warning"> Oui</button>
                            <a class="btn btn-default" href="liste_categorie.php"> Non</a>
                        </div>
                </form>
            </div>
    </div>
